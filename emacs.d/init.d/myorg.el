(use-package org
  ...
  (setq org-src-fontify-natively t
        ...
        org-refile-use-outline-path 'file                                          ;; refile using filenames as top level org-refile-allow-creating-parent-nodes 'confirm                            ;; prompt when creating top level refiles
  ...
  (setq org-todo-keywords
    ...
    (setq org-agenda-files '("~/Gitlab/organizer/tasks" "~/vizzie/doc/office")
